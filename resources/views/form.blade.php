...
@section('content')
    <header class="row-fluid">
        <h1 id="banner"><i class="fa fa-usd red" aria-hidden="true"></i> {{ $year }} Federal Tax Estimator <i class="fa fa-usd green" aria-hidden="true"></i></h1>
    </header>
            ...
            <form action="taxyear{{$year}}/estimate" method='get' name="taxForm">
                ...
                <fieldset id="filing_status">
                    ...
                    <div class="infoBox" id="statusInfoBox">
                        ...
                        <p>if you are unmarried, have qualified dependents, and pay for at least 50% of the household bills.</p>
                        
                        <h3>Married Filing Separately</h3>
                        <p>if you are married and you and your spouse are filing separate, individual tax returns. Spouses cannot be claimed with this status.</p>
                        
                        <h3>Married Filing Jointly</h3> 
                        <p>if you are married and you are filing a joint return with your spouse. Spouses are generally claimed with this status.</p>
                        
                        <h3>Qualified Widow(er)</h3> 
                        <p>if your spouse passed away during the tax year. This status allows for a higher standard deduction.</p>
                    </div>          
                    <span class="require-symbol" title="Required">* </span>
                ...
                <fieldset id="exemptions">
                    ...
                    <div class="infoBox" id="exemptionsInfoBox">
                        ...
                        <p>You can claim yourself only if you are not claimed on someone else's tax return. If you are single and do not select yourself, your standard deduction will be adjusted to $1050 to reflect the fact that you are a dependent on another's return.</p>

                        <p>You can only claim a spouse if your filing status is "Married Filing Jointly".</p> 
                ...
                <fieldset id="deductAdjust">
                    ...
                    <div class="infoBox" id="adjustInfoBox">
                        <p>Depending upon your filing status, each of the follow checkboxes results in a higher adjustment of your standard deduction. The adjustment differs according to your status.</p>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="infoBox" id="incomeInfoBox">
                        <p>Your total employment income is typically found on your W2 Form under Box #1.</p>

                        <p>Include all additional income, including gambling winnings, interest dividends, 1099 Forms, etc.</p>

                        <p>Your federal income tax withheld is typically found on your W2 Form under Box #2.</p>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row-fluid infoBox" id="creditsInfoBox">
                        <p>This estimator does not determine if you are eligible for tax credits. However, if you are aware of your eligibility, then insert the amounts below.</p>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row-fluid infoBox" id="studentInfoBox">
                        <p>Any school tuition paid during the tax year can be deducted without itemizing up to $4000.</p>

                        <p>Any student loan interest paid during the tax year can be deducted without itemizing up to $2500.</p>

                        <p>There are income limitations. If your status is "Married Filing Jointly" and your total income exceeds $160,000, these deductions cannot be made. Likewise, if you are filing under any other status, the income limitation is $80,000.</p>
                    </div>
