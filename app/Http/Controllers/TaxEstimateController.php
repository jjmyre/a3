...
class TaxEstimateController extends Controller
{
	public function estimate2016(Request $request){
        ...
        $this->validate($request, [
            ...
            'status' => 'required',
            'dependents' => 'nullable|numeric|max:15',
            'income' => 'required|numeric|min:1',
            'addIncome' => 'nullable|numeric',
        ...
        if($childCredit == 'yes') {
            $this->validate($request, [
                'childCreditAmount' => 'required|numeric',
                ]);
        }

        if($otherCredit == 'yes') {
            $this->validate($request, [
                'otherCreditAmount' => 'required|numeric',
                ]);
        }
        ...
        // Return View after form submission
